    ...
    <div class="fb-overlay" id="fb-overlay">\
      <div class="fb-form">\
        ...
        <form id="fb-form-inner">\
          ...
          <div class="fb-field"><label for="fb-date">date</label><input type="date" id="fb-date" required></div>\
